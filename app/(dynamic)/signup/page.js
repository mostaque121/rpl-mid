...
import GoogleSignin from "../signin/component/Google";
import Logo from "../signin/component/logo";
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="md:w-96 w-full h-screen overflow-y-scroll scrollbar-hidden md:px-8 px-5 pt-8  pb-10">
        <Logo />
        <h1 className="text-3xl mt-12 md:mt-8">Create your account</h1>

        <div className=" w-full ">
          <h2 className="pt-4 pb-12 font-semibold text-dark-gray">
            Have an account?
            <Link href={'/signin'}>
              <span className="text-blue-600 hover:text-blue-700 duration-200 transition-all ease active:text-blue-800"> Sign in</span>
            </Link>
